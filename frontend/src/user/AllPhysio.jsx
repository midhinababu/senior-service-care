...
function AllPhysio() {
  ...
  const viewnurses = async () => {
    const result = await viewAllphysio(reqHeader);
    console.log(result);
  ...
  return (
    <Col>
      ...
      >
        {/* Heading */}
        <h2 className="text-center mb-4">Connecting You with Physiotherapist</h2>

        {/* Search & Filters */}
        <Row className="mb-4 justify-content-center g-2">
          <Col xs={12} md={6}>
            <InputGroup>
              <Form.Control placeholder="Search by Name or Specialty" />
            </InputGroup>
          </Col>
          {/* <Col xs="auto">
